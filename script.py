...
© 𝗕𝘆 @DKBOTZFUTURE 𝗧𝗲𝗮𝗺 ⭕"""
    ...
    SOURCE_MSG = """𝗧𝗵𝗶𝘀 𝗕𝗼𝘁 𝗖𝗿𝗲𝗮𝘁𝗲𝗱 𝗕𝘆 @DKBOTZHELP.\n\n𝗬𝗼𝘂 𝗪𝗶𝗹𝗹 𝗚𝗲𝘁 𝗧𝗵𝗶𝘀 𝗕𝗼𝘁 𝗦𝗼𝘂𝗿𝗰𝗲 𝗖𝗼𝗱𝗲 𝗙𝗿𝗼𝗺 𝗠𝘆 𝗢𝘄𝗻𝗲𝗿.\n\n𝗧𝗵𝗶𝘀 𝗕𝗼𝘁 𝗢𝗻 𝗩𝗣𝗦 𝗪𝗮𝗻𝘁 𝗗𝗼𝗻𝗮𝘁𝗲 𝗧𝗼 𝗗𝗼𝗻𝗮𝘁𝗲 𝗠𝘆 𝗢𝘄𝗻𝗲𝗿.\n\n© 𝗕𝘆 @DKBOTZFUTURE 𝗧𝗲𝗮𝗺 ❤️"""
